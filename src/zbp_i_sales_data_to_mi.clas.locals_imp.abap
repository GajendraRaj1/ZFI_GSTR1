...
*//( - ) by Anurag
      ...
      LOOP AT it_purchase_ml INTO DATA(wa_sales).
        ...
        tot_tax_val      = tot_tax_val + wa_sales-Taxable_Value_In_RS .
...
*    gst_rate1 = ceil( gst_rate ).
        ...
        IF ( wa_sales-Billing_Type = 'F2' OR wa_sales-Billing_Type = 'F3' )  AND wa_sales-transactioncurrency = 'INR'.
          inv_cat    = 'TXN'.
        ELSEIF wa_sales-Billing_Type = 'CBD2' OR wa_sales-Billing_Type = 'CBRE' OR wa_sales-Billing_Type = 'JSTO' OR wa_sales-Billing_Type = 'JSP'.
          inv_cat    = 'TXN'.
        ELSEIF wa_sales-Billing_Type = 'G2'.
          inv_cat    = 'CDN'.
        ELSEIF wa_sales-Billing_Type = 'L2'.
          inv_cat    = 'DDN'.
        ELSEIF wa_sales-Billing_Type = 'F2' AND wa_sales-transactioncurrency <> 'INR'.
          inv_cat    = 'EXP'.
        ELSEIF wa_sales-Doc_type = 'DG' AND wa_sales-transactioncurrency <> 'INR'.
          sup_type   = 'NOR'.
        ELSEIF wa_sales-Doc_type = 'DR' AND wa_sales-transactioncurrency <> 'INR'.
          sup_type   = 'NOR'.
        ENDIF.
        ...
        ELSEIF ( wa_sales-Billing_Type = 'G2' OR wa_sales-Billing_Type = 'L2' )  AND wa_sales-transactioncurrency = 'INR'
          ...
          inv_type   = 'B2CS'.
        ELSEIF wa_sales-Doc_type = 'DG' AND wa_sales-transactioncurrency <> 'INR' AND wa_sales-Totaltax = 0.
          inv_type   = 'WOPAY'.
          place_supp = '97'.
        ELSEIF wa_sales-Doc_type = 'DG' AND wa_sales-transactioncurrency <> 'INR' AND wa_sales-Totaltax <> 0.
          inv_type   = 'WPAY'.
          place_supp = '97'.
        ELSEIF wa_sales-Doc_type = 'DR' AND wa_sales-transactioncurrency <> 'INR' AND wa_sales-Totaltax = 0.
          inv_type   = 'WOPAY'.
          place_supp = '97'.
        ELSEIF wa_sales-Doc_type = 'DR' AND wa_sales-transactioncurrency <> 'INR' AND wa_sales-Totaltax <> 0.
          inv_type   = 'WPAY'.
